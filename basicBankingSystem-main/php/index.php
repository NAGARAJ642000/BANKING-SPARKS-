...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">BANK SYSTEM <img src="logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
             <strong>WELCOME TO SPARKS BANK</strong> <img src="banklogo.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="bgg1.jpg" width="1000" height="375" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="bgg3.jpg" width="1000" height="375" class="d-block w-100" alt="...">
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="350" height="300" src="cc1.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
